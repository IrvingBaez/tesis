...
if __name__=='__main__':
	...
	avd_tests = [
		{'data_type': data_type, 'denoiser': 'noisereduce', 'vad_detector': 'ground_truth', 'asd_detector': 'ground_truth',	'avd_detector': 'avr_net'},
		{'data_type': data_type, 'denoiser': 'noisereduce', 'vad_detector': 'ground_truth', 'asd_detector': 'light_asd', 		'avd_detector': 'avr_net'}
	]
