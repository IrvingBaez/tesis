...
from model.util import argparse_helper, save_data
...
def load_model(args):
	model = RelationLayer(args.checkpoint)
...
def extract_features(args):
	...
	dataset = CustomDataset(args, training=True)
...
def compute_similarity(args):
	...
	dataloader = DataLoader(dataset, batch_size=1536, shuffle=False, num_workers=0, pin_memory=False, drop_last=False, collate_fn=CustomCollator())
