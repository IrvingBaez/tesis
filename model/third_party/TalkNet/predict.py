		...
		for duration in durationSet:
			...
			with torch.no_grad():
				for i in range(batchSize):
					...
					embedA, embedV = detector.model.forward_cross_attention(embedA, embedV)
...
def initialize_arguments(**kwargs):
	...
	parser.add_argument('--pretrained_model',		type=str, default="model/third_party/TalkNet/weight/pretrain_TalkSet.model",   help='Path for the pretrained model')
